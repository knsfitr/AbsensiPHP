...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO `user` (namauser, password, foto) VALUES (%s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2" style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif">
      ...
      <tr>
        <td><center>
          ...
          <table width="401" border="0" align="center">
            <tr valign="baseline">
              <td width="104" align="left" nowrap="nowrap">Username</td>
              <td width="281"><input type="text" name="namauser" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td height="52" align="left" nowrap="nowrap">Password</td>
